...
<div class="layui-form">
  ...
  <form action="RoomServlet?method=updateRoom" method="post">
  ...
  <div class="layui-form-item" style="width: 550px; ">
    ...
    <div class="layui-input-block" style="width: 400px; ">
      <input type="text" name="roomno" lay-verify="title" class="layui-input"
             value="${room.roomno}" >
    </div>
  </div>
  <div class="layui-form-item" style="width: 550px; ">
    ...
    <div class="layui-input-block" style="width: 400px; ">
      <select name="buildid">
          <c:forEach items="${buildList}" var="item">
              <option value="${item.buildid}">${item.buildname }</option>
          </c:forEach>
      </select>
    </div>
  </div>
