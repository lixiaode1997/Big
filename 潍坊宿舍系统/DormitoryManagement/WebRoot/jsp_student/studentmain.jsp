...
<body>
 <ul class="layui-nav" style="height:60px;text-align: right;margin: 0px">
  ...
  <li class="layui-nav-item">
    <a href="admin_exit">退出</a>
  </li>
 
 
</ul>
<ul class="layui-nav layui-nav-tree layui-nav-side" lay-filter="treenav" style="margin-top: 2px">
    <li class="layui-nav-item"><a href="javascript:;" class="site-url" data-id="1" data-title="查询信息" data-url="">查询信息</a>
    	<dl class="layui-nav-child">
    		<dd><a href="../StudentServlet?method=getById&id=${login.stuid}"/>查询个人信息</a></dd>
    		<dd><a href="../RoomServlet?method=getById&id=${login.roomid.roomid}"/>查询宿舍信息</a></dd>
    	</dl>
    </li>
    	
        <li class="layui-nav-item"><a href="javascript:;" class="site-url" data-id="2" data-title="报修信息" data-url="">报修信息</a>
    	<dl class="layui-nav-child">
    		<dd><a href=""/>查询保修信息</a></dd>
    		<dd><a href="../NoticeServlet?method=getAll"/>申请报修</a></dd>
    	</dl>
    </li>
    
    <li class="layui-nav-item"><a href="javascript:;" class="site-url" data-id="3" data-title="缴费管理"  data-url="">缴费管理</a>
    <dl class="layui-nav-child">
    
    		<dd> <a href=""/>查看缴费信息 </a> </dd>
    		<dd><a href=""/>缴费</a></dd>
    	</dl>
    </li>
    </ul>
<div class="layui-tab layui-tab-brief" lay-filter="contentnav" lay-allowClose="true" style="margin-left:200px;margin-top:0;">
    ...
    <div class="layui-tab-content" style="padding:0;">
        <div class="layui-tab-item layui-show">
					...
					<p style="font-size: 16px">欢迎使用北京五道口幼儿园宿舍管理系统</p>
					</div>
