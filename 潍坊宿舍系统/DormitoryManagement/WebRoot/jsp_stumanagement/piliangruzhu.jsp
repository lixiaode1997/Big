...
<div class="layui-form">
    ...
    <a href="StudentMidServlet?method=piliangruzhu">
    <button class="layui-btn" lay-submit="" lay-filter="demo1" style="width: 150px;">一键入住</button></a>  
    </div>
