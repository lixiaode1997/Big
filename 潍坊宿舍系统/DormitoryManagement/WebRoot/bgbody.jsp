...
<script type="text/javascript">
	$(function() {
	  ...
	  $.ajax({
					...
					type : "POST",
					url : "${pageContext.request.contextPath }/TuServlet",
					dataType: "json",
...
<ul class="layui-nav layui-nav-tree layui-nav-side" lay-filter="treenav" style="margin-top: 2px">
    <li class="layui-nav-item"><a href="javascript:;" class="site-url">宿舍管理</a>
    	<dl class="layui-nav-child">
    		<dd>
    		<a href="javascript:;" class="site-url" data-id="8" data-title="查询宿舍" data-url="RoomServlet?method=getAllRoom"/>查询宿舍</a>
    		</dd>
    		<!-- <dd><a href=""/>增加宿舍</a></dd>
    		<dd><a href=""/>修改宿舍</a></dd>
    		<dd><a href=""/>删除宿舍</a></dd> -->
        ...
        <li class="layui-nav-item"><a href="javascript:;" class="site-url">宿管管理</a>
    	<dl class="layui-nav-child">
    		<dd>
    		<!-- <a href="AdminServlet?method=all">宿管信息查询</a> -->
    		<a href="javascript:;" class="site-url" data-id="2" data-title="宿管信息查询" data-url="AdminServlet?method=all"/>宿管信息查询</a>
    		</dd>
    		<dd>
    		<!-- <a href="BuildingServlet?method=getAll">宿管入职</a> -->
    		<a href="javascript:;" class="site-url" data-id="3" data-title="宿管入职" data-url="BuildingServlet?method=getAll"/>宿管入职</a>
    		</dd>
    		<dd>
<!--     		<a href="AdminServlet?method=allDel">宿管信息退职</a>
 -->    		
 	<a href="javascript:;" class="site-url" data-id="4" data-title="宿管信息退职" data-url="AdminServlet?method=allDel"/>宿管信息退职</a>
    		</dd>
    	 	<dd>
    	 	<!-- <a href="AdminServlet?method=allUpadate">宿管信息修改</a> -->
    	 	<a href="javascript:;" class="site-url" data-id="35" data-title="宿管信息修改" data-url="AdminServlet?method=allUpadate"/>宿管信息修改</a>
    	 	</dd>  
    	</dl>
    </li>
    ...
    <dl class="layui-nav-child">
    		...
    		<dd>
    		<a href="javascript:;" class="site-url" />学生换宿</a>
    		<dl class="layui-nav-child">
                   <li><a href="javascript:;" class="site-url" data-id="19" data-title="单人换宿" data-url="jsp_superadmin/changeroom1.jsp">单人换宿</a></li>
                   <li><a href="javascript:;" class="site-url" data-id="26" data-title="双人互换" data-url="jsp_superadmin/changeroom2.jsp">双人互换</a></li>
                   <li><a href="javascript:;" class="site-url" data-id="31" data-title="宿舍换址" data-url="jsp_superadmin/changeroom3.jsp">宿舍换址</a></li>
                </dl>
    		</dd>
    		
    		<dd><a href="javascript:;" class="site-url" data-id="1" data-title="学生查询" data-url="StudentServlet?method=getAll"/>学生查询</a></dd>
    		<dd><a href="javascript:;" class="site-url" data-id="1" data-title="审批报修" data-url="NoticeServlet?method=adminGetAll&flag=1"/>审批报修</a></dd>
    	</dl>
    </li>
...
<div class="layui-tab layui-tab-brief" lay-filter="contentnav" lay-allowClose="true" style="margin-left:200px;margin-top:0;">
    ...
    <div class="layui-tab-content" style="padding:0;">
        <div class="layui-tab-item layui-show">
					<div style="height: 100%; width: 80%; margin-top: 30px;margin-left: 30px">
    ...
    if(obj.event === 'frozen'){
      layer.confirm('确定冻结？', function(index){
        			console.log(obj);
         			...
         			$.ajax({
                		...
                		error:function(){
                			layer.msg("冻结失败"+date.bid, {icon: 5});
                		},
            		});
      });
      ...
      layer.open({
			        ...
			        yes: function (index, layero) {
			            ...
			            $.post('zXLUserupdServlet', formData, function (data) {
