...
<div class="layui-form">
  <form action="AdminServlet?method=add" method="post">
  <div>
  <br>
  ...
  <div class="layui-form-item" style="width: 550px; ">
    ...
    <div class="layui-input-block" style="width: 400px; ">
      <input type="text" name="adminname" lay-verify="title" autocomplete="off" placeholder="请输入名称" class="layui-input">
    </div>
  </div>
  ...
  <div class="layui-form-item" style="width: 550px; ">
    ...
    <div class="layui-input-block" style="width: 400px; ">
      <input type="text" name="adminpwd" lay-verify="title" autocomplete="off" placeholder="请输入名称" class="layui-input">
    </div>
  </div>
