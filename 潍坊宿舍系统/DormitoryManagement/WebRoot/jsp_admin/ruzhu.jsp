...
<div class="layui-form">
  <form action="StudentServlet?method=fenpei" method="post">
  <div>
  <br>
  ...
  <div class="layui-form-item" style="width: 550px; ">
    ...
    <div class="layui-input-block" style="width: 400px; ">
      <select name="dept" lay-filter="aihao">
        <c:forEach items="${uio}" var="iList">
        
              <option value="${iList.deptid }">${iList.deptname }</option>
              <%-- <input type="hidden" name="dept" value="${iList.deptid }"> --%>
          </c:forEach>
      </select>
